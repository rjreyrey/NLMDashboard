...
class Titlebar extends Component {
    ...
    render() {
        return <div className="inner">
            ...
            <div className="browserControls hidden">
                <i className="fas fa-arrow-left browserBack disabled"></i>
                <i className="fas fa-arrow-right browserForward disabled"></i>
                <i className="fas fa-redo-alt browserRefresh disabled"></i>
            </div>
